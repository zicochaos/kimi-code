 ...
 *
 * Gates the model directory and exact-alias model parameter exposed by Agent and
 ...
 * Composes with `secondary-model`: when this flag is off, only the primary/
 * secondary enum path remains.
 */
