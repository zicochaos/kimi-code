...
import { AGENTS_MD_EXPAND_INCLUDES_SECTION } from '@moonshot-ai/agent-core-v2/agent/profile/configSection';
      ...
      const prepared = await prepareSystemPromptContext(
        {
          ...
          pathClass: this.engineAccessor.get(IHostEnvironment).pathClass,
        },
        ...
        this.engineAccessor.get(IBootstrapService).homeDir,
        {
          ...
          expandIncludes:
            this.engineAccessor.get(IConfigService).get(AGENTS_MD_EXPAND_INCLUDES_SECTION) === true,
        },
      );
